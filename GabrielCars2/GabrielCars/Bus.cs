...
namespace GabrielCars
{
    internal class Bus:Car
    {
        ...
        /// Поездка
        /// </summary>
        protected override void Move() //!!!вызывается повторно после конца маршрута
        {
            if (this._volCur == 0)
            {
        ...
        /// Разгон
        /// </summary>
        protected override void SpeedUp() ////такой же, как в Truck; от Car отличается наличием percent
        {
