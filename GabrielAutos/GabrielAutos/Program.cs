			...
			while (next != "выход")
			{
				...
				switch (operChoice)
				{
						...
						case 3:
						{
                            ...
                            if (avtos[avtoChoice].topCheck == 1)
							{
						...
						case 5:
						{
							...
							if (avtos[avtoChoice].nomCheck == 1)
							{
								Console.WriteLine("Количество возможных аварий с участием этих машин: " + avtos[avtoChoice].acc);
							}
							else
							{
								Console.WriteLine("Номер машины для сверки введён неверно.");
							}

                            avtos[avtoChoice].nomCheck = 0;
                            avtos[avtoChoice].acc = 0;
